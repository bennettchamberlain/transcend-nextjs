...
export function HomeHeaderSection() {
  ...
  return (
    <header
      ref={headerRef}
      className="relative z-50 min-h-[700px] overflow-hidden bg-black pb-20 shadow-sm lg:min-h-[800px] lg:pb-20"
    >
      {/* Navigation */}
      <NavigationSection />
      ...
      <div className="absolute inset-x-0 top-[152px] w-full lg:top-[152px]" style={{ bottom: "80px" }}>
        ...
        <div
          className="absolute top-0 right-0 left-0 z-40 h-0.5"
          style={{
        ...
        <div
          className="absolute right-0 bottom-0 left-0 z-30 h-0.5"
          style={{
            boxShadow: "0 0 20px #dcff07, 0 0 40px #dcff07, 0 0 60px #dcff07",
      ...
      <div className="pointer-events-none absolute inset-x-0 top-[180px] bottom-[80px] z-10 flex items-center justify-center">
