...
export default function MulticamDashboardPage() {
    ...
    return (
      <div className="min-h-screen bg-black text-white">
        ...
        <div className="mx-auto max-w-md p-8">
          <h1 className="mb-6 text-3xl font-bold">Multicam Dashboard Login</h1>
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="mx-auto max-w-7xl p-8">
        <h1 className="mb-8 text-3xl font-bold">Multicam Dashboard</h1>
